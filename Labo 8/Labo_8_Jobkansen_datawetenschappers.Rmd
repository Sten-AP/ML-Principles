---
title: 'Labo 8: Jobkansen datawetenschappers'
...
## Waar gaat de dataset precies over?
Personen in verschillende steden met een andere achtergrond die eventueel werk hebben of werk zoeken.

## Waarom zijn er drie bestanden?
Een bestand om te leren, een bestand om te testen en de uitkomsten.
Omdat bij het leren de dataset verranderd kan worden en bij het testen word dan het originele gebruikt.

## Wat beteken de variabelen
...
# SHAP library
shap.plot.summary.wrap1(model, X = train_data, top_n = 11)

xgb.plot.shap(train_data, model = model, top_n = 11, n_col = 3)
```
...
Code van MIGUEL FZZZ
https://www.kaggle.com/miguelfzzz/predicting-staff-turnover-xgboost-80-accuracy#exploratory-data-analysiseda
